...
import static utils.E_SecretQuestion.PetName;
import utils.E_VehicleType;
import utils.E_UserType;
import static utils.E_UserType.Admin;
import static utils.E_UserType.User;
...
public class MainClass {
	...
	public static void main(String[] args) {
                ...
                try{
                 controller.deserialization(Constants.Ser_FileName);
                   }
                catch (IOException i) {
                    System.out.println("Failed deserialization!");
                }
		view = ViewLogic.getInstance();
                        view.FirstLoginScreen();
	}
	/**
       ...
       public static void readCSVFile (String fileName)
       {
           try {
			...
			while ((line = reader.readNext()) != null) {
				switch (line[0]) {
					...
					case "addSlot":
						...
						break;
                                        case "addUser":
						controller.addUser(line[1], line[2], E_UserType.valueOf(line[3]), E_SecretQuestion.valueOf(line[4]), line[5]);
						break;
			...
			reader.close();
                  ...
                  controller.addUser("Administrator","administrator",Admin,PetName,"Gregory");
                  controller.addUser("User","user",User,PetName,"Jim");
                  System.out.println("Created 2 default users!");
		}
		finally {
