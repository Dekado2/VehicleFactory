...
public class Manufacturer implements Cloneable,Serializable{
	...
	protected Manufacturer(String name, Address address, double profitPercentage) {
		...
		producedPartTypes = new HashSet<E_PartCategory>();
	}
    /**
    * 
    ...
    */
    ...
    /**
     * 
     * @return Manufacturer profit percentage
     */
	 ...
	 */
	public Set<VehicleModel> getProducedModels() {
	 ...
	 */
	public boolean addProducedModel(VehicleModel modelToAdd) {
		//TODO Complete this method
	 ...
	 */
	public Set<E_PartCategory> getProducedPartTypes() {
		//TODO Complete this method
