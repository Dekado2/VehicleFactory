 ...
 *
 */
public class VehicleModel  implements Comparable<VehicleModel>, Cloneable,Serializable {
    ...
    /**
     * 
     * @return whether the vehicle is Automatic
     */
    ...
    /**
     * 
     * @return date when the vehicle entered production
     */
    public Calendar getEnteredProduction() {
        return enteredProduction;
    }
    /**
     * 
     * @return Production Plan Type of Vehicle Model
     */
    public ProductionPlanType getProductionPlanType() {
	 ...
	 */
	public Map<PartType, Integer> getRequiredParts() {
