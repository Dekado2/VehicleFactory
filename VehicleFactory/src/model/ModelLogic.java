...
public class ModelLogic implements Serializable{
	...
	public Map<String, Manufacturer> getManufacturers() {
		...
		return Collections.unmodifiableMap(data.getManufacturers());
	}
	/**
	 * @return the orders
	 */
	public Map<Integer, Order<?, ?>> getOrders() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getOrders());
	}
	/**
	 * @return the parts
	 */
	public Map<Integer, PartType> getParts() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getParts());
	}
	/**
	 * @return the productionPlans
	 */
	public Map<Integer, ProductionPlan> getProductionPlans() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getProductionPlans());
	}
	/**
	 * @return the productionPlanTypes
	 */
	public Map<Integer, ProductionPlanType> getProductionPlanTypes() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getProductionPlanTypes());
	}
	/**
	 * @return the models
	 */
	public Map<String, VehicleModel> getModels() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getModels());
	}
	/**
	 * @return the vehicles
	 */
	public Map<String, Vehicle> getVehicles() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getVehicles());
	}
	/**
	...
	public Map<Integer, Warehouse> getWarehouses() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getWarehouses());
	}
	/**
	...
	public Map<Integer, WorkStation> getWorkStations() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getWorkStations());
	}
	/**
	 * @return the shifts
	 */
	public Map<Calendar, Shift> getShifts() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getShifts());
	}
	/**
	 * @return the employees
	 */
	public Map<String, AbstractEmployee> getEmployees() {
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getEmployees());
	}
        /**
         * 
         * @return the users
		...
		//TODO Complete this method
		return Collections.unmodifiableMap(data.getUsers());
	}
	/**
	...
	public boolean addSlot(Calendar startingTime, int productionPlanSerial) {
        ...
        {
            return data.addUser(username, password, type, secretQuestion, secretAnswer);
        }
	/**
	...
	public boolean removeShift(Calendar startingTime) {
		...
		//TODO Complete this method
		return data.removeSlot(startingTime);
	}
	...
	public boolean updateManufacturer(String name, String country, String city, String street,
			int houseNumber, String zipCode, double profitPercentage) {
		//TODO Complete this method
		return data.updateManufacturer(name, country, city, street, houseNumber, zipCode, profitPercentage);
	}
	/**
	...
	public boolean updateWarehouse(int warehouseNumber, String country, String city, String street,
			int houseNumber, String zipCode, int maxPartsStored, int maxVehiclesStored) {
		//TODO Complete this method
		return data.updateWarehouse(warehouseNumber, country, city, street, houseNumber, zipCode, maxPartsStored, maxVehiclesStored);
	}
	/**
	...
	public boolean updateProductionPlanType(int serialNumber, int numberOfSlots) {
		//TODO Complete this method
		return data.updateProductionPlanType(serialNumber, numberOfSlots);
	}
	/**
	...
	public boolean updateProductionPlan(int serialNumber, int typeSerialNumber) {
		//TODO Complete this method
		return data.updateProductionPlan(serialNumber, typeSerialNumber);
	}
	/**
	...
	public boolean updateVehicleModel(int productionPlanTypeSerial, String modelName,
			...
			boolean isAutomatic, double productionCost, Calendar enteredProduction) {
		//TODO Complete this method
		return data.updateVehicleModel(productionPlanTypeSerial, modelName, vehicleType, hp, topSpeed, numOfSeats, isAutomatic, productionCost, enteredProduction);
	}
	/**
	...
	public boolean updatePartType(int partNumber, String partName, E_PartCategory category, double productionCost) {
		//TODO Complete this method
		return data.updatePartType(partNumber, partName, category, productionCost);
	}
	/**
	...
	public boolean updateOrder(int orderNumber, String orderedFrom, String orderedTo, Calendar dueDate) {
		//TODO Complete this method
		return data.updateOrder(orderNumber, orderedFrom, orderedTo, dueDate);
	}
	/**
	...
	public boolean updateVehicle(String vin, String modelName, int productionPlanSerial, int orderNumber) {
		//TODO Complete this method
		return data.updateVehicle(vin, modelName, productionPlanSerial, orderNumber);
	}
	/**
	...
	public boolean updateWorkStation(int stationNumber, E_PartCategory cat) {
		//TODO Complete this method
		return data.updateWorkStation(stationNumber, cat);
	}
	/**
	...
	public boolean updateGuard(String id, String name, String country, String city, String street,
			...
			double monthlySalary, int warehouseNumber) {
		//TODO Complete this method
		return data.updateGuard(id, name, country, city, street, houseNumber, zipCode, birthday, employmentDate, monthlySalary, warehouseNumber);
	}
	/**
	...
	public boolean updateShiftManager(String id, String name, String country, String city, String street,
			...
			double hourlyWage, double extraWage) {
		//TODO Complete this method
		return data.updateShiftManager(id, name, country, city, street, houseNumber, zipCode, birthday, employmentDate, hourlyWage, extraWage);
	}
	/**
	 * updates a worker
	 * @param id Worker id
	...
	public boolean updateWorker(String id, String name, String country, String city, String street,
			...
			double hourlyWage) {
		//TODO Complete this method
		return data.updateWorker(id, name, country, city, street, houseNumber, zipCode, birthday, employmentDate, hourlyWage);
	}
	/**
	...
	public boolean updateShift(Calendar startingTime, String ShiftManagerId) {
		//TODO Complete this method
		return data.updateShift(startingTime, ShiftManagerId);
	}
	/**
	 * update a slot
	 * You need to determine the shift according to the slot time
	...
	public boolean updateSlot(Calendar startingTime, int productionPlanSerial) {
		//TODO Complete this method
		return data.updateSlot(startingTime, productionPlanSerial);
	}
         /**
          * Update a user
          * @param username
        ...
        {
            return data.updateUser(username, password, type, secretQuestion, secretAnswer);
        }
	/**
	...
	public boolean removePartCategoryFromManufacturer(String manufacturerName, E_PartCategory partCategory) {
		...
		if (m == null)
			return false;
		 boolean bool=m.removeProducedPartType(partCategory);
                 if (bool==true){
                 for (PartType pt: data.getParts().values()){
                     if (pt.getCategory().equals(partCategory) && pt.getManufacturers().contains(m)){
    ...
    */
    ...
    {
        return data.deserialize(fileName);
    }
}
