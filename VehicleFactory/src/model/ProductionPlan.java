 ...
 *
 */
public class ProductionPlan implements Cloneable,Serializable{
    ...
    /**
     * 
     * @return Production Plan Serial Number
     */
    ...
    /**
     * 
     * @return Production Plan type
     */
    public ProductionPlanType getType() {
        return type;
    }
	 ...
	 */
	public Map<Calendar, Slot> getSlots() {
		//TODO Complete this method
	 ...
	 * @return True if added successfully
	 */
	protected boolean updateSlot(Slot slot) {
		//TODO Complete this method
		if (isGood())
			return false;
		slots.put(slot.startingTime, slot);
