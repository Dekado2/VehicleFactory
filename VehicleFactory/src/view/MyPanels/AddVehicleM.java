 ...
 *
 */
public class AddVehicleM extends javax.swing.JPanel {
private static ViewLogic view;
private UserMenu um;
    /**
     * Creates new form AddVehicleM
     */
    public AddVehicleM(UserMenu um) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel25.setText(bundle.getString("AddVehicleM.jLabel25.text")); // NOI18N
        ...
        productionCostLabel.setText(bundle.getString("AddVehicleM.productionCostLabel.text")); // NOI18N

        hpLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        hpLabel.setForeground(new java.awt.Color(87, 84, 84));
        hpLabel.setText(bundle.getString("AddVehicleM.hpLabel.text")); // NOI18N
    ...
    private void addPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPanelMouseClicked
     ...
     if (!addPanel.getBackground().equals(c))
     {
        ...
        else if (productioncost!=null && productioncost>0)
        {
            ...
            {
            bool=view.controller.addVehicleModel(serialnumber,nameText.getText(), e, hp, speed, seats, automaticCheckBox.isSelected(),productioncost,cal);
            if (bool==true)
            {
                Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
            JOptionPane.showMessageDialog(null, "Vehicle Model added successfully!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "דגם הרכב הוסף בהצלחה!");
            serialText.setText("");
            nameText.setText("");
            ...
            yearComboBox.setSelectedIndex(0);
             ...
             {
                VehicleModel vm=view.model.getModels().get(nameText.getText());
                ProductionPlanType ppt=view.model.getProductionPlanTypes().get(serialnumber);
                if (vm!=null)
                {
                    Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                JOptionPane.showMessageDialog(null, "Vehicle Model " + nameText.getText() + " already exists!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "דגם רכב " + nameText.getText() + " כבר קיים!");
                nameText.grabFocus();
                }
                else if (vm==null && ppt==null)
                {
                    Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
