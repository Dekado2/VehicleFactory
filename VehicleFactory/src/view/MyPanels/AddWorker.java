...
private UserMenu um;
    ...
    private void initComponents() {
        ...
        nameLabel.setText(bundle.getString("AddWorker.nameLabel.text")); // NOI18N

        countryLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        countryLabel.setForeground(new java.awt.Color(87, 84, 84));
        countryLabel.setText(bundle.getString("AddWorker.countryLabel.text")); // NOI18N
        ...
        employmentDateLabel.setText(bundle.getString("AddWorker.employmentDateLabel.text")); // NOI18N

        birthDateLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        birthDateLabel.setForeground(new java.awt.Color(87, 84, 84));
        birthDateLabel.setText(bundle.getString("AddWorker.birthDateLabel.text")); // NOI18N
        ...
        jLabel25.setText(bundle.getString("AddWorker.jLabel25.text")); // NOI18N
        ...
        idLabel.setText(bundle.getString("AddWorker.idLabel.text")); // NOI18N

        hourlyWageLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        hourlyWageLabel.setForeground(new java.awt.Color(87, 84, 84));
        hourlyWageLabel.setText(bundle.getString("AddWorker.hourlyWageLabel.text")); // NOI18N
        ...
        jLabel30.setText(bundle.getString("AddWorker.jLabel30.text")); // NOI18N

        jLabel31.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(87, 84, 84));
        jLabel31.setText(bundle.getString("AddWorker.jLabel31.text")); // NOI18N
        ...
        jLabel32.setText(bundle.getString("AddWorker.jLabel32.text")); // NOI18N
     ...
     if (!addPanel.getBackground().equals(c))
     {
        ...
        else if (hourlyWage!=null && hourlyWage<=0)
        {
        ...
        else if (hourlyWage!=null && hourlyWage>0)
          {
            ...
            {
            bool=view.controller.addWorker(idText.getText(),nameText.getText(),countryText.getText(),cityText.getText(),streetText.getText(),hn,zipText.getText(), bcal, ecal,hourlyWage);
            if (bool==true)
            {
                Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
            JOptionPane.showMessageDialog(null, "Worker added successfully!");
                ...
                JOptionPane.showMessageDialog(null, "העובד הוסף בהצלחה!");
            idText.setText("");
            nameText.setText("");
            countryText.setText("");
            cityText.setText("");
