...
private UserMenu um;
    ...
    private void initComponents() {
        ...
        vinLabel.setText(bundle.getString("AddVehicle.vinLabel.text")); // NOI18N
        ...
        jLabel25.setText(bundle.getString("AddVehicle.jLabel25.text")); // NOI18N
        ...
        modelLabel1.setText(bundle.getString("AddVehicle.modelLabel1.text")); // NOI18N

        productionRadioButton.setBackground(new java.awt.Color(235, 255, 255));
        buttonGroup1.add(productionRadioButton);
        productionRadioButton.setSelected(true);
        productionRadioButton.setText(bundle.getString("AddVehicle.productionRadioButton.text")); // NOI18N
        ...
        orderRadioButton.setBackground(new java.awt.Color(235, 255, 255));
        buttonGroup1.add(orderRadioButton);
        orderRadioButton.setText(bundle.getString("AddVehicle.orderRadioButton.text")); // NOI18N
        ...
        orderText.setText(bundle.getString("AddVehicle.orderText.text")); // NOI18N
    ...
    private void addPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPanelMouseClicked
     ...
     if (!addPanel.getBackground().equals(c))
     {
        ...
        else if (serialnum!=null && serialnum>0)
        {
            ...
            {
            bool=view.controller.addVehicle(vinText.getText(), modelText.getText(),serialnum,ordernum);
            if (bool==true)
            {
                Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
            ...
            else
            {
                ...
                if (vehicle!=null)
                {
                    Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                    JOptionPane.showMessageDialog(null, "Vehicle " + vinText.getText() + " already exists!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "רכב " + vinText.getText() + " כבר קיים!");
                    vinText.grabFocus();
                }
                else if (vehicle==null && vm==null)
                {
                    Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
             JOptionPane.showMessageDialog(null, "Vehicle Model " + modelText.getText() + " does not exist!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "דגם רכב " + modelText.getText() + " אינו קיים!");
                 modelText.grabFocus();
                }
               else if (vehicle==null && pp==null)
                {
                    Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
             JOptionPane.showMessageDialog(null, "Production Plan " + serialnum + " does not exist!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "תכנית יצור " + serialnum + " אינה קיימת!");
                 ppText.grabFocus();
                }
               else if (vehicle==null && !pp.getType().equals(vm.getProductionPlanType()))
                {
                    Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
             JOptionPane.showMessageDialog(null, "Vehicle Model " + modelText.getText() + " cannot be produced with Production Plan " + serialnum + "!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "דגם רכב " + modelText.getText() + " אינו יכול להיות מיוצר עם תכנית היצור " + serialnum + "!");
                 modelText.grabFocus();
                }
             }
            }
        ...
        else if (ordernum!=null && ordernum>0)
          {
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
             JOptionPane.showMessageDialog(null, "Vehicle Model " + modelText.getText() + " does not exist!");
                ...
                else if (vehicle==null && order==null)
                {
                    Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
             JOptionPane.showMessageDialog(null, "Order Number " + ordernum + " does not exist!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "מספר הזמנה " + ordernum + " אינו קיים!");
                 orderText.grabFocus();
                }
