 ...
 *
 */
public class ShowModels extends javax.swing.JPanel {
private static ViewLogic view;
private UserMenu um;
    /**
     * Creates new form ShowModels
     */
    public ShowModels(UserMenu um) {
        initComponents();
        view=ViewLogic.getInstance();
        this.um=um;
        view.ShowDataModels(resTable,um.getLanguageComboBox());
    }
    ...
    private void initComponents() {
        ...
        resTableScrollPane.setBorder(null);
        ...
        tableLayeredPaneLayout.setHorizontalGroup(
            ...
            .addGroup(tableLayeredPaneLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(resTableScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 753, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tableLayeredPaneLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, tableLayeredPaneLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(resTableScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 227, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        remove.setText(bundle.getString("ShowModels.remove.text")); // NOI18N
        ...
        update.setText(bundle.getString("ShowModels.update.text")); // NOI18N
        ...
        more.setText(bundle.getString("ShowModels.more.text")); // NOI18N
    ...
    private void removeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_removeActionPerformed
        ...
        if (resTable.getSelectedRow()==-1){
            ...
            JOptionPane.showMessageDialog(null, "עליך לבחור דגם מהטבלה!");    
        }
        else
        {
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
              ...
              if (n==0)
              {
            bool=view.controller.removeVehicleModel(resTable.getValueAt(resTable.getSelectedRow(), 0).toString());
              if (bool==true)
              {
                  Toolkit.getDefaultToolkit().beep();
                  if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                  JOptionPane.showMessageDialog(null, "Vehicle model removed successfully!");
                  else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                  JOptionPane.showMessageDialog(null, "דגם הרכב הוסר בהצלחה!");    
                  view.ShowDataModels(resTable,um.getLanguageComboBox());
              }
              else{
                  Toolkit.getDefaultToolkit().beep();
                  if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                  JOptionPane.showMessageDialog(null, "                                                         Vehicle model was not removed!\n Please make sure that no manufacturers can produce it and there aren't any vehicles of this model!");
                  else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                  JOptionPane.showMessageDialog(null, "דגם הרכב לא הוסר!                                        \n אנא ודא קודם שאין יצרנים המסוגלים ליצור דגם זה ושאין שום רכבים מדגם זה!");    
              }
              }
        }
