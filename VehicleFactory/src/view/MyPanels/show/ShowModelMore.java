 ...
 *
 */
public class ShowModelMore extends javax.swing.JPanel {
    private static ViewLogic view1;
    private String modelName;
    private UserMenu um;
    /**
     * Creates new form ShowModelMore
     */
    public ShowModelMore(UserMenu um) {
        initComponents();
    ...
    private void initComponents() {
        ...
        icon_plus.setText(bundle.getString("ShowModelMore.icon_plus.text")); // NOI18N

        icon_remove.setIcon(new javax.swing.ImageIcon(getClass().getResource("/view/icons/003-interface.png"))); // NOI18N
        icon_remove.setText(bundle.getString("ShowModelMore.icon_remove.text")); // NOI18N
        ...
        amountLabel.setText(bundle.getString("ShowModelMore.amountLabel.text")); // NOI18N
        amountLabel.setVisible(false);
        amountLabel.setEnabled(false);
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(amountSeparator, javax.swing.GroupLayout.DEFAULT_SIZE, 342, Short.MAX_VALUE)
    ...
    private void jComboBox1ItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jComboBox1ItemStateChanged
        ...
        if(txt.equals("Add Part") || txt.equals("הוסף חלק")){
            ...
            view1.AddPartToModel(partsTable, modelName,um.getLanguageComboBox());
             amountText.setText("");
        ...
        if(txt.equals("Remove Part") || txt.equals("הסר חלק")){
            ...
            partsTableLayeredPane_add.setVisible(true);
            view1.removePartFromModel(partsTable, modelName,um.getLanguageComboBox());
             amountText.setText("");
        ...
        else if (partnumber!=null && partnumber>0)
        {
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
              ...
              n = JOptionPane.showOptionDialog(null, "האם אתה בטוח שברצונך להמשיך?","אימות הסרה",JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE,null,hebOptions,hebOptions[1]);
                if (n==0)
                {
                    bool=view1.controller.removePartFromModel((Integer)partsTable.getValueAt(partsTable.getSelectedRow(),0),partnumber,modelName);
                    if (bool==true)
                    {
                        Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                ...
                JOptionPane.showMessageDialog(null, "החלק הוסר בהצלחה!");
                        ...
                        Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                        JOptionPane.showMessageDialog(null, "You may remove a maximum of " + view1.model.getModels().get(modelName).getRequiredParts().get(view1.model.getParts().get((Integer)partsTable.getValueAt(partsTable.getSelectedRow(),0))) + " parts!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "ניתן להסיר כמות מקסימלית של " + view1.model.getModels().get(modelName).getRequiredParts().get(view1.model.getParts().get((Integer)partsTable.getValueAt(partsTable.getSelectedRow(),0))) + " חלקים!");
                    }
                }
            }
          }
        ...
        else if (partnumber!=null && partnumber>0)
        {
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
              ...
              n = JOptionPane.showOptionDialog(null, "האם אתה בטוח שברצונך להמשיך?","אימות הוספה",JOptionPane.YES_NO_OPTION,JOptionPane.INFORMATION_MESSAGE,null,hebOptions,hebOptions[1]);
                if (n==0)
                {
                   bool=view1.controller.addPartToModel((Integer)partsTable.getValueAt(partsTable.getSelectedRow(),0),partnumber,modelName);
                    if (bool==true)
                    {
                        Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
