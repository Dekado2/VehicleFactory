 ...
 *
 */
public class AddWh extends javax.swing.JPanel {
private static ViewLogic view;
private UserMenu um;
    /**
     * Creates new form AddManu
     */
    public AddWh(UserMenu um) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel25.setText(bundle.getString("AddWh.jLabel25.text")); // NOI18N
     ...
     if (!addPanel.getBackground().equals(c))
     {
        ...
        else if (maxvehicles!=null && maxvehicles>=0)
        {
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
              ...
              if (n==0)
              {
            bool=view.controller.addWarehouse(wnumber,countryText.getText(), cityText.getText(),streetText.getText(),housenumber,zipText.getText(), maxparts,maxvehicles);
            if (bool==true)
            {
                Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
            JOptionPane.showMessageDialog(null, "Warehouse added successfully!");
                ...
                JOptionPane.showMessageDialog(null, "המחסן הוסף בהצלחה!");
            numberText.setText("");
            countryText.setText("");
            cityText.setText("");
            streetText.setText("");
            ...
            maxvehiclesText.setText("");
             ...
             {
                Warehouse warehouse=view.model.getWarehouses().get(wnumber);
                if (warehouse!=null)
                {
                    Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                JOptionPane.showMessageDialog(null, "Warehouse " + wnumber + " already exists!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "מחסן " + wnumber + " כבר קיים!");
                numberText.grabFocus();
                }
             }
              }
