 ...
 *
 */
public class UpdateShiftM extends javax.swing.JPanel {
...
private UserMenu um;
     ...
     */
    public UpdateShiftM(UserMenu um) {
        initComponents();
    ...
    private void initComponents() {
        ...
        nameLabel.setText(bundle.getString("UpdateShiftM.nameLabel.text")); // NOI18N

        countryLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        countryLabel.setForeground(new java.awt.Color(87, 84, 84));
        countryLabel.setText(bundle.getString("UpdateShiftM.countryLabel.text")); // NOI18N
        ...
        employmentDateLabel.setText(bundle.getString("UpdateShiftM.employmentDateLabel.text")); // NOI18N

        bdayLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        bdayLabel.setForeground(new java.awt.Color(87, 84, 84));
        bdayLabel.setText(bundle.getString("UpdateShiftM.bdayLabel.text")); // NOI18N

        extraWageLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        extraWageLabel.setForeground(new java.awt.Color(87, 84, 84));
        extraWageLabel.setText(bundle.getString("UpdateShiftM.extraWageLabel.text")); // NOI18N
        ...
        jLabel25.setText(bundle.getString("UpdateShiftM.jLabel25.text")); // NOI18N
        ...
        idLabel.setText(bundle.getString("UpdateShiftM.idLabel.text")); // NOI18N

        hourlyWageLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        hourlyWageLabel.setForeground(new java.awt.Color(87, 84, 84));
        hourlyWageLabel.setText(bundle.getString("UpdateShiftM.hourlyWageLabel.text")); // NOI18N
        ...
        jLabel30.setText(bundle.getString("UpdateShiftM.jLabel30.text")); // NOI18N

        jLabel31.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(87, 84, 84));
        jLabel31.setText(bundle.getString("UpdateShiftM.jLabel31.text")); // NOI18N
        ...
        jLabel32.setText(bundle.getString("UpdateShiftM.jLabel32.text")); // NOI18N
    ...
    private void addPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPanelMouseClicked
     ...
     if (!addPanel.getBackground().equals(c))
     {
        ...
        else if (extraWage!=null && extraWage>0)
        {
            ...
            {
            bool=view.controller.updateShiftManager(idText.getText(),nameText.getText(),countryText.getText(),cityText.getText(),streetText.getText(),hn,zipText.getText(), bcal, ecal,hourlyWage,extraWage);
            if (bool==true)
            {
            Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))   
            JOptionPane.showMessageDialog(null, "Shift Manager updated successfully!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
            JOptionPane.showMessageDialog(null, "מנהל המשמרת עודכן בהצלחה!");
...
private void emptyFields(JTextField field, JTextField  fieldtwo, JTextField  fieldthree ,JTextField  fieldfour ,JTextField  fieldfive, JTextField  fieldsix,JTextField  fieldseven,JTextField fieldeight,JTextField fieldnine, JPanel add){
    ...
    public JTextField getExtraWageText() {
        return extraWageText;
    }
