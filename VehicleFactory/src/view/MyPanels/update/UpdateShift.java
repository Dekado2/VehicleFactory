 ...
 *
 */
public class UpdateShift extends javax.swing.JPanel {
private static ViewLogic view;
private UserMenu um;
    /**
     * Creates new form AddShift
     */
    public UpdateShift(UserMenu um) {
        initComponents();
    ...
    private void initComponents() {
        ...
        smLabel.setText(bundle.getString("UpdateShift.smLabel.text")); // NOI18N
        ...
        jLabel25.setText(bundle.getString("UpdateShift.jLabel25.text")); // NOI18N
        ...
        startingTimeLabel.setText(bundle.getString("UpdateShift.startingTimeLabel.text")); // NOI18N

        jLabel31.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(87, 84, 84));
        jLabel31.setText(bundle.getString("UpdateShift.jLabel31.text")); // NOI18N
        ...
        jLabel30.setText(bundle.getString("UpdateShift.jLabel30.text")); // NOI18N
        ...
        jLabel32.setText(bundle.getString("UpdateShift.jLabel32.text")); // NOI18N
        ...
        timeLabel.setText(bundle.getString("UpdateShift.timeLabel.text")); // NOI18N
    ...
    private void addPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPanelMouseClicked
     ...
     if (!addPanel.getBackground().equals(c))
     {
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
              ...
              if (n==0)
              {
            bool=view.controller.updateShift(cal,smText.getText());
            if (bool==true)
            {   
            Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))    
            JOptionPane.showMessageDialog(null, "Shift updated successfully!");
                ...
                JOptionPane.showMessageDialog(null, "המשמרת עודכנה בהצלחה!");
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))    
                ...
                JOptionPane.showMessageDialog(null, "מנהל המשמרת " + smText.getText() + " אינו קיים!");
                  smText.grabFocus();
                }
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))    
                 ...
                 JOptionPane.showMessageDialog(null, smText.getText() + " הוא לא מנהל משמרת!");
                    smText.grabFocus();
                }
             }
           }
