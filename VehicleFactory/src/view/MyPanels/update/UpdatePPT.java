 ...
 *
 */
public class UpdatePPT extends javax.swing.JPanel {
private static ViewLogic view;
private UserMenu um;
    /**
     * Creates new form AddPPT
     */
    public UpdatePPT(UserMenu um) {
    ...
    private void initComponents() {
        ...
        serialNumberLabel.setText(bundle.getString("UpdatePPT.serialNumberLabel.text")); // NOI18N
        ...
        numberOfSlotsLabel.setText(bundle.getString("UpdatePPT.numberOfSlotsLabel.text")); // NOI18N
        ...
        jLabel25.setText(bundle.getString("UpdatePPT.jLabel25.text")); // NOI18N
        ...
        else if (numofslots!=null && numofslots<=0)
        {
        ...
        else if (numofslots!=null && numofslots>0)
          {
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
              ...
              if (n==0)
              {
            bool=view.controller.updateProductionPlanType(serialnum, numofslots);
            if (bool==true)
            {
            Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))    
            JOptionPane.showMessageDialog(null, "Production Plan Type updated successfully!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
            JOptionPane.showMessageDialog(null, "סוג תכנית היצור עודכן בהצלחה!");
...
private void emptyFields(JTextField field, JTextField  fieldtwo, JPanel add){
    ...
    public JTextField getNumberOfSlotsText() {
        return numberOfSlotsText;
    }
