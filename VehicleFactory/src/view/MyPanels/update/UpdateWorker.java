 ...
 *
 */
public class UpdateWorker extends javax.swing.JPanel {
...
private UserMenu um;
     ...
     */
    public UpdateWorker(UserMenu um) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Panel_AddWorker = new javax.swing.JPanel();
        ...
        Panel_AddWorker.setBackground(new java.awt.Color(235, 255, 255));
        Panel_AddWorker.setForeground(new java.awt.Color(255, 255, 255));
        ...
        nameLabel.setText(bundle.getString("UpdateWorker.nameLabel.text")); // NOI18N

        countryLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        countryLabel.setForeground(new java.awt.Color(87, 84, 84));
        countryLabel.setText(bundle.getString("UpdateWorker.countryLabel.text")); // NOI18N
        ...
        employmentDateLabel.setText(bundle.getString("UpdateWorker.employmentDateLabel.text")); // NOI18N

        birthDateLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        birthDateLabel.setForeground(new java.awt.Color(87, 84, 84));
        birthDateLabel.setText(bundle.getString("UpdateWorker.birthDateLabel.text")); // NOI18N
        ...
        DocumentListener docListener = new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent e) {
                emptyFields(idText,nameText, countryText, cityText,streetText,hnText,zipText,hourlyWageText, addPanel);
            }
            @Override
        ...
        jLabel25.setText(bundle.getString("UpdateWorker.jLabel25.text")); // NOI18N
        ...
        idLabel.setText(bundle.getString("UpdateWorker.idLabel.text")); // NOI18N

        hourlyWageLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        hourlyWageLabel.setForeground(new java.awt.Color(87, 84, 84));
        hourlyWageLabel.setText(bundle.getString("UpdateWorker.hourlyWageLabel.text")); // NOI18N
        ...
        jLabel30.setText(bundle.getString("UpdateWorker.jLabel30.text")); // NOI18N

        jLabel31.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(87, 84, 84));
        jLabel31.setText(bundle.getString("UpdateWorker.jLabel31.text")); // NOI18N
        ...
        jLabel32.setText(bundle.getString("UpdateWorker.jLabel32.text")); // NOI18N
        ...
        javax.swing.GroupLayout Panel_AddWorkerLayout = new javax.swing.GroupLayout(Panel_AddWorker);
        Panel_AddWorker.setLayout(Panel_AddWorkerLayout);
        Panel_AddWorkerLayout.setHorizontalGroup(
            Panel_AddWorkerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(Panel_AddWorkerLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(Panel_AddWorkerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(Panel_AddWorkerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
        ...
        Panel_AddWorkerLayout.setVerticalGroup(
            Panel_AddWorkerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(Panel_AddWorkerLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(Panel_AddWorkerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(Panel_AddWorkerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGap(18, 18, 18)
                .addGroup(Panel_AddWorkerLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(Panel_AddWorker, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(Panel_AddWorker, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
     ...
     if (!addPanel.getBackground().equals(c))
     {
        ...
        else if (hourlyWage!=null && hourlyWage<=0)
        {
        ...
        else if (hourlyWage!=null && hourlyWage>0)
          {
            ...
            {
            bool=view.controller.updateWorker(idText.getText(),nameText.getText(),countryText.getText(),cityText.getText(),streetText.getText(),hn,zipText.getText(), bcal, ecal,hourlyWage);
            if (bool==true)
            {
                Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
            JOptionPane.showMessageDialog(null, "Worker updated successfully!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
            JOptionPane.showMessageDialog(null, "העובד עודכן בהצלחה!");    
...
private void emptyFields(JTextField field, JTextField  fieldtwo, JTextField  fieldthree ,JTextField  fieldfour ,JTextField  fieldfive, JTextField  fieldsix,JTextField  fieldseven,JTextField fieldeight, JPanel add){
    ...
    public JTextField getHourlyWageText() {
    ...
    private javax.swing.JPanel Panel_AddWorker;
