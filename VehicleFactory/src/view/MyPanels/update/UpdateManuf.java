 ...
 *
 */
public class UpdateManuf extends javax.swing.JPanel {
private static ViewLogic view;
private UserMenu um;
    /**
     * Creates new form AddManu
     */
    public UpdateManuf(UserMenu um) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel25.setText(bundle.getString("UpdateManuf.jLabel25.text")); // NOI18N
        ...
        streetLabel.setText(bundle.getString("UpdateManuf.streetLabel.text")); // NOI18N

        countryLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        countryLabel.setForeground(new java.awt.Color(87, 84, 84));
        countryLabel.setText(bundle.getString("UpdateManuf.countryLabel.text")); // NOI18N
        ...
        else if (profitpercentage!=null && profitpercentage<=0 || profitpercentage>=1)
        {
        ...
        else if (profitpercentage!=null && profitpercentage>0 && profitpercentage<1)
          {
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
              ...
              if (n==0)
              {
            bool=view.controller.updateManufacturer(nameText.getText(),countryText.getText(), cityText.getText(),streetText.getText(),housenumber,zipText.getText(), profitpercentage);
            if (bool==true)
            {
                Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
            JOptionPane.showMessageDialog(null, "Manufacturer updated successfully!");
                ...
                JOptionPane.showMessageDialog(null, "היצרן עודכן בהצלחה!");
...
private void emptyFields(JTextField field, JTextField  fieldtwo, JTextField  fieldthree ,JTextField  fieldfour ,JTextField  fieldfive, JTextField  fieldsix,JTextField  fieldseven, JPanel add){
    ...
    public JTextField getProfitPercentageText() {
        return profitPercentageText;
    }
