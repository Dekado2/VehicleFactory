 ...
 *
 */
public class UpdateGuard extends javax.swing.JPanel {
...
private UserMenu um;
     ...
     */
    public UpdateGuard(UserMenu um) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel25.setText(bundle.getString("UpdateGuard.jLabel25.text")); // NOI18N
        ...
        idLabel.setText(bundle.getString("UpdateGuard.idLabel.text")); // NOI18N

        msLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        msLabel.setForeground(new java.awt.Color(87, 84, 84));
        msLabel.setText(bundle.getString("UpdateGuard.msLabel.text")); // NOI18N
        ...
        jLabel30.setText(bundle.getString("UpdateGuard.jLabel30.text")); // NOI18N

        jLabel31.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(87, 84, 84));
        jLabel31.setText(bundle.getString("UpdateGuard.jLabel31.text")); // NOI18N
        ...
        jLabel32.setText(bundle.getString("UpdateGuard.jLabel32.text")); // NOI18N
    ...
    private void addPanelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addPanelMouseClicked
     ...
     if (!addPanel.getBackground().equals(c))
     {
        ...
        else if (wnumber!=null && wnumber>0)
        {
            ...
            {
            bool=view.controller.updateGuard(idText.getText(),nameText.getText(),countryText.getText(),cityText.getText(),streetText.getText(),hn,zipText.getText(), bcal, ecal,ms,wnumber);
            if (bool==true)
            {
                Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
            JOptionPane.showMessageDialog(null, "Guard updated successfully!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "השומר עודכן בהצלחה!");
...
private void emptyFields(JTextField field, JTextField  fieldtwo, JTextField  fieldthree ,JTextField  fieldfour ,JTextField  fieldfive, JTextField  fieldsix,JTextField  fieldseven,JTextField fieldeight,JTextField fieldnine, JPanel add){
    ...
    public JComboBox<String> getBdayComboBox() {
        return bdayComboBox;
    }

    public JComboBox<String> getBmonthComboBox() {
        return bmonthComboBox;
    }

    public JComboBox<String> getByearComboBox() {
        return byearComboBox;
    }
    ...
    public JComboBox<String> getEdayComboBox() {
        return edayComboBox;
    }

    public JComboBox<String> getEmonthComboBox() {
        return emonthComboBox;
    }

    public JComboBox<String> getEyearComboBox() {
        return eyearComboBox;
    }
    ...
    public JTextField getWnumberText() {
        return wnumberText;
    }
