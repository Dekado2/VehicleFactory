...
private UserMenu um;
    ...
    private void initComponents() {
        ...
        jLabel25.setText(bundle.getString("AddOrder.jLabel25.text")); // NOI18N
        ...
        jLabel30.setText(bundle.getString("AddOrder.jLabel30.text")); // NOI18N

        jLabel31.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        jLabel31.setForeground(new java.awt.Color(87, 84, 84));
        jLabel31.setText(bundle.getString("AddOrder.jLabel31.text")); // NOI18N
        ...
        jLabel32.setText(bundle.getString("AddOrder.jLabel32.text")); // NOI18N
        ...
        dueDateLabel.setText(bundle.getString("AddOrder.dueDateLabel.text")); // NOI18N
        ...
        orderedFromLabel.setText(bundle.getString("AddOrder.orderedFromLabel.text")); // NOI18N
        ...
        orderNumberLabel.setText(bundle.getString("AddOrder.orderNumberLabel.text")); // NOI18N
        ...
        m_btn.setText(bundle.getString("AddOrder.m_btn.text")); // NOI18N
        ...
        sm_btn2.setText(bundle.getString("AddOrder.sm_btn2.text")); // NOI18N
        ...
        m_btn2.setText(bundle.getString("AddOrder.m_btn2.text")); // NOI18N
        ...
        sm_btn.setText(bundle.getString("AddOrder.sm_btn.text")); // NOI18N
        ...
        orderedToLabel.setText(bundle.getString("AddOrder.orderedToLabel.text")); // NOI18N
        ...
        orderedFromNameLabel.setText(bundle.getString("AddOrder.orderedFromNameLabel.text")); // NOI18N
        ...
        orderedToNameLabel.setText(bundle.getString("AddOrder.orderedToNameLabel.text")); // NOI18N
            ...
            else
            {
                ...
                if (sm_btn.isSelected() && m_btn2.isSelected())
               {
                      ...
                      if (order!=null)
                 {
                     Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                   JOptionPane.showMessageDialog(null, "Order " + ordernum + " already exists!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "הזמנה " + ordernum + " כבר קיימת!");
                   orderNumberText.grabFocus();
                 }
                  else if (order==null && sm==null)
                 {
                      Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                ...
                JOptionPane.showMessageDialog(null, "מנהל משמרת " + orderedFromNameText.getText() + " אינו קיים!");
                   ...
                   else if (order==null && !(sm instanceof ShiftManager))
                 {
                     Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
            ...
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                ...
                JOptionPane.showMessageDialog(null, "יצרן " + orderedToNameText.getText() + " אינו קיים!");
                   orderedToNameText.grabFocus();
                      ...
                      else if (order==null && sm instanceof ShiftManager & manu!=null)
        {
        bool=view.controller.addOrder(ordernum,orderedFromNameText.getText(),orderedToNameText.getText(),cal);
            if (bool==true)
            {   
                Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                ...
                JOptionPane.showMessageDialog(null, "הזמנה " + ordernum + " כבר קיימת!");
                  ...
                  else if (order==null && sm==null)
                 {
                   ...
                   JOptionPane.showMessageDialog(null, "Shift Manager " + orderedToNameText.getText() + " does not exist!");
                         ...
                         JOptionPane.showMessageDialog(null, "מנהל משמרת " + orderedToNameText.getText() + " אינו קיים!");
                   orderedToNameText.grabFocus();
                 }
                   else if (order==null && !(sm instanceof ShiftManager))
                 {
                   ...
                   JOptionPane.showMessageDialog(null, orderedToNameText.getText() + " is not a Shift Manager!");
                         ...
                         JOptionPane.showMessageDialog(null, orderedToNameText.getText() + " הוא אינו מנהל משמרת!");
                   orderedToNameText.grabFocus();
                 }
                   else if (order==null && sm instanceof ShiftManager & manu!=null)
        {
            ...
            {   
              ...
              JOptionPane.showMessageDialog(null, "Order added successfully!");
                         ...
                         JOptionPane.showMessageDialog(null, "ההזמנה הוספה בהצלחה!");
              orderNumberText.setText("");
              sm_btn.setSelected(true);
              if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language")){
              orderedFromNameLabel.setText("Shift Manager ID");
...
public JPanel getPanel_AddOrder() {
        return Panel_AddOrder;
    }
