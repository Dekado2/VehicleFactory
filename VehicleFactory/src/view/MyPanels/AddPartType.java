 ...
 *
 */
public class AddPartType extends javax.swing.JPanel {
private static ViewLogic view;
private UserMenu um;
    /**
     * Creates new form AddPartType
     */
    public AddPartType(UserMenu um) {
        initComponents();
    ...
    private void initComponents() {
        ...
        partNumberLabel.setText(bundle.getString("AddPartType.partNumberLabel.text")); // NOI18N
        ...
        jLabel25.setText(bundle.getString("AddPartType.jLabel25.text")); // NOI18N
        ...
        partNameLabel.setText(bundle.getString("AddPartType.partNameLabel.text")); // NOI18N

        categoryLabel.setFont(new java.awt.Font("Aharoni", 0, 16)); // NOI18N
        categoryLabel.setForeground(new java.awt.Color(87, 84, 84));
        categoryLabel.setText(bundle.getString("AddPartType.categoryLabel.text")); // NOI18N
        ...
        productionCostLabel.setText(bundle.getString("AddPartType.productionCostLabel.text")); // NOI18N
     ...
     if (!addPanel.getBackground().equals(c))
     {
        ...
        else if (productioncost!=null && productioncost<=0)
        {
        ...
        else if (productioncost!=null && productioncost>0)
          {
            ...
            {
            bool=view.controller.addPartType(partnumber,partNameText.getText(), e ,productioncost);
            if (bool==true)
            {
                Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
            JOptionPane.showMessageDialog(null, "Part Type added successfully!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "סוג החלק הוסף בהצלחה!");
            ...
            productionCostText.setText("");
             ...
             {
                PartType pt=view.model.getParts().get(partnumber);
                if (pt!=null)
                {
                    Toolkit.getDefaultToolkit().beep();
            if (um.getLanguageComboBox().getSelectedItem().equals("English") || um.getLanguageComboBox().getSelectedItem().equals("Choose a language"))
                JOptionPane.showMessageDialog(null, "Part Type " + partnumber + " already exists!");
            else if (um.getLanguageComboBox().getSelectedItem().equals("עברית"))
                JOptionPane.showMessageDialog(null, "סוג חלק " + partnumber + " כבר קיים!");
                partNumberText.grabFocus();
                }
             }
            }
